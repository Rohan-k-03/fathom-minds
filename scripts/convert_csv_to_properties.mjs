#!/usr/bin/env node
/**
 * Convert Property_Boundaries.csv to properties JSON and merge into sample-data/properties.json
 * - Infers headers from first row
 * - Converts area to m^2 based on units (ha/hectares → * 10,000; m^2 stays)
 * - Generates ids continuing from the highest existing like ALB-012 → ALB-013, ...
